Contributing to CrystalPro Core
==================================

The CrystalPro Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CrystalPro Core project, and is not to be
confused with overall CrystalPro Network Protocol consensus changes.

Whether a pull request is merged into CrystalPro Core rests with the project merge
...
Patches that change CrystalPro consensus rules are considerably more involved than
...
Where a patch set proposes to change the CrystalPro consensus, it must have been
...
The project leader is the release manager for each CrystalPro Core release.
