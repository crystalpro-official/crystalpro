...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/crystalpro-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/crystalpro-cli.cpp \
           src/crystalpro-tx.cpp \
           src/crystalpro.cpp \
           src/db.cpp \
           ...
           src/qt/crystalpro.cpp \
           src/qt/crystalprostrings.cpp \
...
RESOURCES += src/qt/crystalpro.qrc src/qt/crystalpro_locale.qrc

TRANSLATIONS += src/qt/locale/crystalpro_bg.ts \
                src/qt/locale/crystalpro_de.ts \
                src/qt/locale/crystalpro_en.ts \
                src/qt/locale/crystalpro_es.ts \
                src/qt/locale/crystalpro_fi.ts \
                src/qt/locale/crystalpro_fr.ts \
                src/qt/locale/crystalpro_it.ts \
                src/qt/locale/crystalpro_ja.ts \
                src/qt/locale/crystalpro_pl.ts \
                src/qt/locale/crystalpro_pt.ts \
                src/qt/locale/crystalpro_ru.ts \
                src/qt/locale/crystalpro_sk.ts \
                src/qt/locale/crystalpro_sv.ts \
                src/qt/locale/crystalpro_vi.ts \
                src/qt/locale/crystalpro_zh_CN.ts \
                src/qt/locale/crystalpro_zh_TW.ts
