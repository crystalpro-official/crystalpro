...
This means one can have an always-on crystalprod instance running, and another local crystalprod/crystalpro-qt instance which connects to this node and receives blocks from it.
