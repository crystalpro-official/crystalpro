...
Intro
-----
CrystalPro (CRP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. CrystalPro utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run crystalpro-qt.exe.

CrystalPro Core is the original CrystalPro client and it builds the backbone of the network.
However, it downloads and stores the entire history of CrystalPro transactions;
