...
In order to support loading of multiple wallets in crystalpro-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is crystalpro.cpp.
...
Changes to crystalpro.cpp
----------------------
crystalpro.cpp is the entry point into crystalpro-qt, and as such, will require some minor modifications to provide hooks for
