...
This mechanism has been integrated into Bitcore-Node-CrystalPro which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/crystalpro/insight-api-crystalpro#web-socket-api](https://github.com/crystalpro/insight-api-crystalpro#web-socket-api)
* API: [https://github.com/crystalpro/insight-api-crystalpro#swifttx-transactions](https://github.com/crystalpro/insight-api-crystalpro#swifttx-transactions)
...
By default, the CrystalPro Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CrystalPro Core daemon:
