...
#   c) node1 mines 32 blocks, so now node 0 has 500000CRP, node 1 has 4250CRP, node2 has none.
#   d) node0 sends 601 CRP to node2, in two transactions (301 CRP, then 300 CRP).
