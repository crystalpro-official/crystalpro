...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CrystalPro Core crystalpro-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  crystalpro-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded crystalpro transaction") + "\n" +
                               "  crystalpro-tx [options] -create [commands]   " + _("Create hex-encoded crystalpro transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded crystalpro transaction
