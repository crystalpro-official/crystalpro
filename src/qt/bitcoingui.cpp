                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CrystalPro Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CRP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and crystalpro: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CrystalPro Core"), this);
    aboutAction->setStatusTip(tr("Show information about CrystalPro Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CrystalPro"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CRP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CRP addresses"));
    ...
    openAction->setStatusTip(tr("Open a crystalpro: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CrystalPro Core help message to get a list with possible CrystalPro command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CrystalPro Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CrystalPro network", "", count));
}
...
{
    QString strTitle = tr("CrystalPro Core"); // default title
