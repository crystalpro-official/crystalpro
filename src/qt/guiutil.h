...
/** Utility functions used by the CrystalPro Qt UI.
 */
namespace GUIUtil
{
...
// Render CRP addresses in monospace font
...
// Parse "crystalpro:" URI into recipient object, return true on successful parsing
