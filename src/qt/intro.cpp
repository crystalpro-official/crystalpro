...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CrystalPro Core"),
     ...
     * override -datadir in the crystalpro.conf file in the default data directory
     * (to be consistent with crystalprod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
