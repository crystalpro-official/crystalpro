...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CrystalPro server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CrystalPro server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CrystalPro features */
        {"crystalpro", "masternode", &masternode, true, true, false},
        {"crystalpro", "listmasternodes", &listmasternodes, true, true, false},
        {"crystalpro", "getmasternodecount", &getmasternodecount, true, true, false},
        {"crystalpro", "masternodeconnect", &masternodeconnect, true, true, false},
        {"crystalpro", "masternodecurrent", &masternodecurrent, true, true, false},
        {"crystalpro", "masternodedebug", &masternodedebug, true, true, false},
        {"crystalpro", "startmasternode", &startmasternode, true, true, false},
        {"crystalpro", "createmasternodekey", &createmasternodekey, true, true, false},
        {"crystalpro", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"crystalpro", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"crystalpro", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"crystalpro", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"crystalpro", "getmasternodescores", &getmasternodescores, true, true, false},
        {"crystalpro", "mnbudget", &mnbudget, true, true, false},
        {"crystalpro", "preparebudget", &preparebudget, true, true, false},
        {"crystalpro", "submitbudget", &submitbudget, true, true, false},
        {"crystalpro", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"crystalpro", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"crystalpro", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"crystalpro", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"crystalpro", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"crystalpro", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"crystalpro", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"crystalpro", "checkbudgets", &checkbudgets, true, true, false},
        {"crystalpro", "mnsync", &mnsync, true, true, false},
        {"crystalpro", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> crystalpro-cli " + methodname + " " + args + "\n";
}
